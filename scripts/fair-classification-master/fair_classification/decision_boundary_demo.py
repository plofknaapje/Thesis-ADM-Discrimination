...
def train_test_classifier():
    ...
    correlation_dict_test = ut.get_correlations(
        None, None, all_class_labels_assigned_test, x_control_test, sensitive_attrs)
    cov_dict_test = ut.print_covariance_sensitive_attrs(
        None, x_test, distances_boundary_test, x_control_test, sensitive_attrs)
...
def plot_boundaries(w1, w2, p1, p2, acc1, acc2, fname):
    ...
    plt.scatter(X_s_0[y_s_0 == 1.0][:, 1], X_s_0[y_s_0 == 1.0][:, 2],
    ...
    plt.scatter(X_s_1[y_s_1 == 1.0][:, 1], X_s_1[y_s_1 == 1.0][:, 2],
...
plot_boundaries(w_uncons, w_a_cons_fine, p_uncons, p_a_cons_fine,
                acc_uncons, acc_a_cons_fine, "img/a_cons_fine.png")
